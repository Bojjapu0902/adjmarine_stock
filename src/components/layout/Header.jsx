  ...
  return (
    <header className="app-header">
      ...
      <div className="header-actions">
        <button className="header-icon-btn" title="Refresh data">
          <MdRefresh />
        </button>
        ...
        <div ref={dropdownRef} style={{ position: 'relative' }}>
          ...
          {dropdownOpen && (
            <div style={{
              ...
              {/* Menu items */}
              {[
                { icon: <MdPerson />,   label: 'My Profile',   action: () => setDropdown(false) },
                { icon: <MdSettings />, label: 'Settings',     action: () => setDropdown(false) },
              ].map((item) => (
                <button
                  key={item.label}
                  onClick={item.action}
              ...
              <button
                ...
                style={{
                  width: '100%', display: 'flex', alignItems: 'center', gap: 10,
                  padding: '10px 16px 14px', background: 'none', border: 'none',
